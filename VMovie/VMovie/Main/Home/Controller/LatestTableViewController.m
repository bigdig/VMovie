...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"LatestCell"];
    }
    
    cell.textLabel.text = [NSString stringWithFormat:@"Latest----%zd",indexPath.row];
